...
def test_collateral_return_output_excluded() -> None:
    ...
    utxos = {
        "hash": TX_HASH,
        "inputs": [{"address": "addrA", "amount": [{"unit": "lovelace", "quantity": "5000000"}]}],
        "outputs": [
            {
                "address": "addrB",
                "amount": [{"unit": "lovelace", "quantity": "3000000"}],
...
def test_inputs_keyed_by_stable_onchain_index() -> None:
    ...
    _, u1, _ = build_records(
        "t", "address", TX_DETAIL, {"hash": TX_HASH, "inputs": [a, b], "outputs": []}
    )
    _, u2, _ = build_records(
        "t", "address", TX_DETAIL, {"hash": TX_HASH, "inputs": [b, a], "outputs": []}
    )
...
def test_malformed_amount_entry_does_not_raise() -> None:
    ...
    utxos = {
        "hash": TX_HASH,
        "inputs": [{"address": "addrA", "amount": [{"unit": "lovelace"}, {"quantity": "5"}]}],
        "outputs": [],
    }
