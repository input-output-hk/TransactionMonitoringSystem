...
| Live-DB tier | `backend/tests/live_db/` | 70 | ClickHouse + Postgres | Live-DB tier (ClickHouse 26.x + Postgres) |
...
That is 2,254 tests across the seven independent tiers (the recall gate is a
