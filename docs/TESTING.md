...
|---|---|---|---|---|
| Backend hermetic | `backend/tests/` | 1386 | none (all I/O mocked) | Backend (pytest + recall gate) |
| Recall gate | `backend/tests/analysis/` | 580 (subset of the above) | none | Backend (run first, on its own) |
...
That is 2,117 tests across the seven independent tiers (the recall gate is a
