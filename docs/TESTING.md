...
|---|---|---|---|---|
| Backend hermetic | `backend/tests/` | 1466 | none (all I/O mocked) | Backend (pytest + recall gate) |
| Recall gate | `backend/tests/analysis/` | 654 (subset of the above) | none | Backend (run first, on its own) |
...
That is 2,213 tests across the seven independent tiers (the recall gate is a
