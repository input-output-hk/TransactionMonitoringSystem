...
|---|---|---|---|---|
| Backend hermetic | `backend/tests/` | 1359 | none (all I/O mocked) | Backend (pytest + recall gate) |
...
That is 2,084 tests across the seven independent tiers (the recall gate is a
