...
|---|---|---|---|---|
| Backend hermetic | `backend/tests/` | 1376 | none (all I/O mocked) | Backend (pytest + recall gate) |
...
That is 2,101 tests across the seven independent tiers (the recall gate is a
