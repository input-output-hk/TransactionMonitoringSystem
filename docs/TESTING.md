...
|---|---|---|---|---|
| Backend hermetic | `backend/tests/` | 1461 | none (all I/O mocked) | Backend (pytest + recall gate) |
| Recall gate | `backend/tests/analysis/` | 649 (subset of the above) | none | Backend (run first, on its own) |
...
That is 2,208 tests across the seven independent tiers (the recall gate is a
