...
2,254 automated tests across seven tiers. The recall gate is a subset of the
...
| Tier | Location | Tests |
|---|---|---|
| Backend hermetic | `backend/tests/` | 1,497 |
| Recall gate (subset of the above, run first and alone in CI) | `backend/tests/analysis/` | 666 |
| Backend live-DB | `backend/tests/live_db/` | 70 |
