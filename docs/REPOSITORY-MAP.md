...
2,117 automated tests across seven tiers. The recall gate is a subset of the
...
| Tier | Location | Tests |
|---|---|---|
| Backend hermetic | `backend/tests/` | 1,386 |
| Recall gate (subset of the above, run first and alone in CI) | `backend/tests/analysis/` | 580 |
