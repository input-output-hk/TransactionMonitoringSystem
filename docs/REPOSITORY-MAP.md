...
2,188 automated tests across seven tiers. The recall gate is a subset of the
...
| Tier | Location | Tests |
|---|---|---|
| Backend hermetic | `backend/tests/` | 1,444 |
| Recall gate (subset of the above, run first and alone in CI) | `backend/tests/analysis/` | 632 |
| Backend live-DB | `backend/tests/live_db/` | 57 |
