...
const ROWS: { type: AttackType; sev: Severity; riskScore: number; feeAda: number; outputs: number }[] = [
  { type: 'Sandwich', sev: 'LOW', riskScore: 38, feeAda: 0.23, outputs: 2 },
  { type: 'Phishing', sev: 'HIGH', riskScore: 74, feeAda: 0.23, outputs: 47 },
  { type: 'Circular', sev: 'CRITICAL', riskScore: 87, feeAda: 0.23, outputs: 2 },
  { type: 'Multiple Sat', sev: 'HIGH', riskScore: 68, feeAda: 0.52, outputs: 2 },
  { type: 'Large Value', sev: 'MEDIUM', riskScore: 55, feeAda: 0.21, outputs: 1 },
  { type: 'Token Dust', sev: 'LOW', riskScore: 32, feeAda: 0.21, outputs: 1 },
  { type: 'Front Running', sev: 'LOW', riskScore: 41, feeAda: 0.34, outputs: 2 },
  { type: 'Token Dust', sev: 'CRITICAL', riskScore: 91, feeAda: 0.21, outputs: 1 },
  { type: 'Token Dust', sev: 'MEDIUM', riskScore: 58, feeAda: 0.21, outputs: 1 },
