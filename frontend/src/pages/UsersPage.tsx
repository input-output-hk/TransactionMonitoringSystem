  ...
  return (
    <div className="flex flex-col gap-4">
      <section className="rounded-xl border border-border bg-card">
                ...
                {removeMode && (
                  <TableCell className="text-right">
                    <button
                      ...
                      className="rounded-md p-2 text-status-offline transition-colors hover:bg-accent"
                      title="Delete user"
                    >
        ...
        <footer className="flex items-center justify-end gap-1 border-t border-border px-5 py-3 text-xs text-muted-foreground">
          <PageBtn
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <div className="relative">
          ...
          <button
            ...
            className="absolute right-2 top-1/2 -translate-y-1/2 rounded-sm p-1.5 text-muted-foreground hover:bg-accent hover:text-foreground"
            title="Copy link"
          >
