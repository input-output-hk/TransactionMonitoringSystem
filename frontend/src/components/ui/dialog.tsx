	...
	return (
		<DialogPortal>
			...
			<DialogPrimitive.Content
				className={cn(
					"border-border bg-popover text-popover-foreground fixed top-1/2 left-1/2 z-50 grid w-full max-w-md -translate-x-1/2 -translate-y-1/2 gap-4 rounded-xl border p-6 shadow-2xl",
